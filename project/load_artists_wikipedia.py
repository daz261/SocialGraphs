...
if __name__ == '__main__':
    ...
    big_df = pd.read_csv(DATA_PATH / "album_artist_date_table.csv")
    ...
    tqdm.pandas()
    big_df["Artist references"] = big_df["Album link"].progress_apply(get_matches)
    big_df.to_csv("artist_matches.csv")
